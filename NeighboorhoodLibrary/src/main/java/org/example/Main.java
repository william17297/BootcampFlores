...
public class Main {
    public static void main(String[] args) {
        ...
        inventory[0] = new Book(100, "1011234567", "Goosebumps", true, "William");
        inventory[1] = new Book(101, "1011234568", "Mystery Manor", false, "Agatha");
        ...
        inventory[4] = new Book(104, "1011234571", "Time Traveler", false, "Doc Brown");
        inventory[5] = new Book(105, "1011234572", "Galaxy Quest", true, "Zara");
        inventory[6] = new Book(106, "1011234573", "Haunted Hills", false, "Eli");
        ...
        inventory[9] = new Book(109, "1011234576", "Island Escape", false, "Robinson");
        inventory[10] = new Book(110, "1011234577", "Dragon’s Fire", true, "Tolkien");
        inventory[11] = new Book(111, "1011234578", "Winter is Coming", false, "George");
        inventory[12] = new Book(112, "1011234579", "Cyber Age", true, "Neo");
        inventory[13] = new Book(113, "1011234580", "Parallel", true, "Quinn");
        inventory[14] = new Book(114, "1011234581", "Midnight Hour", false, "Stella");
